...
var URL = /*#__PURE__*/function () {
   ...
   *
   * @param {JSON} options Config options for creating URLs
   */
  function URL(options) {
    _classCallCheck(this, URL);

    this.apiMode = options.apiMode || "live";
    this.apiVersion = options.apiVersion || "v2";
    this.gatewayURL = this.apiMode === "sandbox" ? "https://sandbox.gateway.sezzle.com" : "https://gateway.sezzle.com";
  }
  /**
   * Get Checkout endpoint URL
   *
   * @returns {string} Create Checkout URL
   */


  _createClass(URL, [{
    key: "createCheckoutURL",
    value: function createCheckoutURL(isVirtualCard) {
      if (isVirtualCard) {
        return "".concat(this.gatewayURL, "/v2/session/card");
      }

      if (this.apiVersion === "v2") {
        return "".concat(this.gatewayURL, "/v2/session");
      }

      return "".concat(this.gatewayURL, "/v1/checkouts");
    }
    /**
     * Get Capture endpoint URL
     *
     * @returns {string} Capture Payment URL
     */

  }, {
    key: "capturePaymentURL",
    value: function capturePaymentURL(orderIdentifier) {
      if (this.apiVersion === "v2") {
        return "".concat(this.gatewayURL, "/v2/order/").concat(orderIdentifier, "/capture");
      }

      return "".concat(this.gatewayURL, "/v1/checkouts/").concat(orderIdentifier, "/complete");
    }
    /**
     * Get Update Virtual Card Checkout Order ID URL
     *
    ...
    key: "updateVirtualCardCheckoutOrderIDURL",
    value: function updateVirtualCardCheckoutOrderIDURL(sessionID) {
      return "".concat(this.gatewayURL, "/v2/session/").concat(sessionID, "/card");
    }
  }]);
...
var package_0 = __webpack_require__(308);
...
var services_Services = /*#__PURE__*/function () {
  /**
   * Constructor
   *
   * @param {JSON} options Config options for triggering services
   */
  function Services(options) {
    services_classCallCheck(this, Services);

    this.publicKey = options.publicKey ? btoa(options.publicKey) : null;
    this.url = new url({
      apiMode: options.apiMode,
      apiVersion: options.apiVersion
    });
    this.isVirtualCard = options.isVirtualCard || false;
  }
  /**
   * Create Checkout
   *
   * @param {string} publicKey Public Key
   * @param {JSON} payload Checkout Payload
  ...
  services_createClass(Services, [{
    key: "createCheckout",
    value: function createCheckout(publicKey, payload) {
      this.publicKey = publicKey ? btoa(publicKey) : null;
      var endpoint = this.url.createCheckoutURL(this.isVirtualCard);
      return this._makeCall(endpoint, 'POST', payload);
    }
    /**
     * Capturing Payment
     *
     * @param {string} orderIdentifier Order Identifier(Order Reference ID or Order UUID)
     * @param {JSON|null} payload Capture Payload
     * @returns {Promise<*>} Capture Response
     */

  }, {
    key: "capturePayment",
    value: function capturePayment(orderIdentifier, payload) {
      var endpoint = this.url.capturePaymentURL(orderIdentifier);
      return this._makeCall(endpoint, 'POST', payload);
    }
    /**
     * Update Virtual Card Checkout Order ID
     *
     * @param {string} sessionID Session ID
     * @param {JSON|null} payload Request Payload
     * @return {Promise<*>} Update Response
     */

  }, {
    key: "updateVirtualCardCheckoutOrderID",
    value: function updateVirtualCardCheckoutOrderID(sessionID, payload) {
      var endpoint = this.url.updateVirtualCardCheckoutOrderIDURL(sessionID);
      return this._makeCall(endpoint, 'PATCH', payload);
    }
    /**
     * Make HTTP Call
     *
    ...
    key: "_makeCall",
    value: function () {
      var _makeCall2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(endpoint, method) {
        var _this = this;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return fetch(endpoint, {
                  ...
                  headers: {
                    ...
                    'Authorization': "Basic ".concat(this.publicKey) // 'Sezzle-User-Agent': packageFile.description,
                    // 'Sezzle-User-Agent-Version': packageFile.version
              ...
              case 3:
                ...
                return _context.abrupt("return", response.status === 204 ? Promise.resolve(response.ok) : response.json());
...
var Style = /*#__PURE__*/function () {
  ...
  style_createClass(Style, [{
    ...
    /**
     * Apply IFrame CSS to Head of DOM
     */
    value: function applyIFrameCSS() {
      var iframeModalCSS = document.createElement('style');
      iframeModalCSS.innerHTML = this.iFrameCSS;
      document.head.appendChild(iframeModalCSS);
    }
    /**
     * Apply Button CSS to Head of DOM
     */

  }, {
    key: "applyButtonCSS",
    value: function applyButtonCSS() {
      var buttonStyle = document.createElement('style');
      buttonStyle.innerHTML = this.buttonCSS;
      document.head.appendChild(buttonStyle);
    }
    /**
     * Apply Loader CSS to Head of DOM
     */

  }, {
    key: "applyLoaderCSS",
    value: function applyLoaderCSS() {
      var sezzleLoaderCSSElement = document.createElement('style');
      sezzleLoaderCSSElement.innerHTML = this.loaderCSS;
      document.head.appendChild(sezzleLoaderCSSElement);
    }
    /**
     * Apply Bootstrap CSS to Head of DOM
     */

  }, {
    key: "applyGoogleFont",
    value: function applyGoogleFont() {
      var bootstrapCSS = document.createElement('link');
      bootstrapCSS.rel = 'stylesheet';
      bootstrapCSS.href = 'https://fonts.googleapis.com/css?family=Comfortaa:400,700&display=swap';
     ...
     * Iframe CSS
     *
     * @returns {string} Iframe CSS
     */
    get: function get() {
      return "<style>\n                    .open-modal {\n                        font-weight: bold;\n                        background: steelblue;\n                        color: #fff;\n                        padding: 0.75rem 1.75rem;\n                        margin-bottom: 1rem;\n                        border-radius: 5px;\n                    }\n                    .sezzle-incontext-modal {\n                        z-index: 5;\n                        position: fixed;\n                        top: 0;\n                        left: 0;\n                        right: 0;\n                        bottom: 0;\n                        display: flex;\n                        align-items: center;\n                        justify-content: center;\n                        padding: 1rem;\n                        background: rgba(0, 0, 0, 0.8);\n                        cursor: pointer;\n                        visibility: hidden;\n                        opacity: 0;\n                        transition: all 0.35s ease-in;\n                    }\n            \n                    .sezzle-incontext-modal.is-visible {\n                        visibility: visible;\n                        opacity: 1;\n                    }\n            \n                    .sezzle-incontext-modal-dialog {\n                        position: relative;\n                        width: 80%;\n                        height: 80%;\n                        border-radius: 5px;\n                        overflow: inherit;\n                        cursor: default;\n                        background-image:url(https://media.sezzle.com/branding/2.0/styleGuide/loader.svg);\n                        background-repeat:no-repeat;\n                        background-position:50%;\n                        background-size:80px auto;\n                        background-color:#fff;\n                    }\n            \n                    .sezzle-incontext-modal-dialog>iframe {\n                        border: 0;\n                        overflow: hidden;\n                        width: 100%;\n                        height: 100%;\n                        border-radius: 8px;\n                    }\n            \n                    .close-sezzle-incontext-modal {\n                        background-color: #fff;\n                        border: 3px solid #999;\n                        border-radius: 50px;\n                        cursor: pointer;\n                        display: inline-block;\n                        font-family: arial;\n                        font-weight: bold;\n                        position: absolute;\n                        top: -15px;\n                        right: -15px;\n                        font-size: 25px;\n                        line-height: 25px;\n                        width: 30px;\n                        height: 30px;\n                        text-align: center;\n                    }\n                </style>";
    }
    /**
     * Loader CSS
     *
     * @returns {string} Loader CSS
     */
...
/* harmony default export */ var style = (Style);
// CONCATENATED MODULE: ./src/virtual_card.js
...
function virtual_card_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function virtual_card_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function virtual_card_createClass(Constructor, protoProps, staticProps) { if (protoProps) virtual_card_defineProperties(Constructor.prototype, protoProps); if (staticProps) virtual_card_defineProperties(Constructor, staticProps); return Constructor; }

var VirtualCard = /*#__PURE__*/function () {
  /**
   * Creates an instance of Virtual Card.
   *
   * @param {JSON} options Config options for creating Virtual Card Object
   */
  function VirtualCard(options) {
    virtual_card_classCallCheck(this, VirtualCard);

    this.checkoutObject = options.checkoutObject || null;
    this.mode = options.mode || null;
  }
  /**
   * Get Virtual Card Checkout Payload
   *
   * @return {{mode: (*|null), origin: string}} Checkout Payload
   */


  virtual_card_createClass(VirtualCard, [{
    key: "getCheckoutPayload",
    value: function getCheckoutPayload() {
      if (!this.mode) {
      ...
      if ('merchant_reference_id' in this.checkoutObject && this.checkoutObject.merchant_reference_id === "") {
        throw new Error("Provide a value for merchant_reference_id");
      } else if ('amount_in_cents' in this.checkoutObject && this.checkoutObject.amount_in_cents % 1 !== 0) {
        throw new Error("Provide a valid cent value for amount_in_cents");
      } else if ('amount_in_cents' in this.checkoutObject && this.checkoutObject.amount_in_cents <= 0) {
        throw new Error("Provide a positive value for amount_in_cents");
      } else if ('currency' in this.checkoutObject && this.checkoutObject.currency === "") {
        throw new Error("Provide a value for currency");
      }

      delete this.checkoutObject.customer;
      return _objectSpread(_objectSpread({}, payload), this.checkoutObject);
    }
  }]);
...
/* harmony default export */ var virtual_card = (VirtualCard);
...
var Helper = /*#__PURE__*/function () {
  ...
  helper_createClass(Helper, [{
     ...
     */
    value: function objectToQueryString(object) {
      var _this = this;

      return Object.keys(object).map(function (key) {
        if (object[key] instanceof Object) {
          return _this._objectToQueryString(object[key]);
        } else {
...
var modal_Modal = /*#__PURE__*/function () {
   ...
   * Constructor
   *
   * @param {JSON} options Config options for rendering modal
   * @constructor
   */
  function Modal(options) {
    ...
    this.sezzleWindow = options.window || window;
    this.sezzleWindowParams = null;
    this.IsVisibleClassName = "is-visible";
    this.mode = options.mode || 'iframe';
    this.checkoutObject = options.checkoutObject || null;
    ...
    this.apiMode = options.apiMode || null;
    this.apiVersion = options.apiVersion || null;
    this.isVirtualCard = options.isVirtualCard || false;
    this.queryString = "";
    this.virtualCard = new virtual_card({
      mode: this.mode
    });
    this.helper = new helper({});
    this.cancelCallback = options.cancelCallback || null;
    this.failureCallback = options.failureCallback || null;
  }
  /**
   * Modal close
   *
  ...
  modal_createClass(Modal, [{
    ...
    value: function closeModal(e) {
      if (this.sezzleWindowElement && this.mode !== 'iframe' && this.mode !== 'redirect') {
        this.sezzleWindowElement.close();
        this.sezzleWindow.removeEventListener("beforeunload", this.closeModal);

        if (this.sezzleLoaderElement) {
          this.sezzleLoaderElement.style.display = 'none';
        }

        clearInterval(this.interval);
      } else if (e.target === document.querySelector(".sezzle-incontext-modal.is-visible") || e.key === "Escape" && document.querySelector(".sezzle-incontext-modal.is-visible")) {
        var status = confirm("Do you want to terminate the checkout?");

        if (status) {
          document.querySelector(".sezzle-incontext-modal.is-visible").classList.remove(this.IsVisibleClassName);
        }
      }
    }
    /**
    ...
    key: "_makeIFrame",
    value: function _makeIFrame() {
      this.style.applyIFrameCSS();
      var iFrame = document.createElement("iframe");
      iFrame.id = "sezzle-incontext-modal-iframe";
      var iFrameHTML = document.createElement("div");
      iFrameHTML.className = "sezzle-incontext-modal";
      iFrameHTML.innerHTML = "<div class=\"sezzle-incontext-modal-dialog\">\n" + "        <div class=\"close-sezzle-incontext-modal\">x</div>\n" + "    </div>";
      document.getElementById("sezzle-smart-button-container").after(iFrameHTML);
      document.getElementsByClassName("close-sezzle-incontext-modal")[0].after(iFrame);
      document.getElementsByClassName("close-sezzle-incontext-modal")[0].addEventListener("click", function () {
    ...
    key: "_makePopUp",
    value: function _makePopUp() {
      var width = 420,
          height = 750,
          top = this.sezzleWindow.outerHeight / 2 + this.sezzleWindow.screenY - height / 2,
          left = this.sezzleWindow.outerWidth / 2 + this.sezzleWindow.screenX - width / 2;
      this.sezzleWindowParams = ["top=" + top, "left=" + left, "width=" + width, "height=" + height, "scrollbars=yes", "status=yes", "resizable=yes"];
      this.addSezzleLoader(false, "Checkout is in progress. Click here if you can't see the Sezzle Window.");
    }
    /**
     * Open Modal Handler
     */
    ...
    value: function openModal() {
      try {
        ...
        if (this.isVirtualCard) {
          this.queryString = this.checkoutObject && this.checkoutObject.customer ? "&".concat(this.helper.objectToQueryString(this.checkoutObject.customer)) : '';
          this.virtualCard.checkoutObject = this.checkoutObject;
          this.checkoutObject = this.virtualCard.getCheckoutPayload();
        }

        switch (this.mode) {
          case "iframe":
            this._hostIFrameCheckout();

            break;

          case "popup":
            this._hostPopUpWindowCheckout();

            break;

          default:
            throw new Error("Checkout Mode not identified. Use iframe/popup");
        }
      } catch (e) {
        alert(e);
      }
    ...
    /**
     * Host IFrame Checkout
     *
     * @private
     */

  }, {
    key: "_hostIFrameCheckout",
    value: function _hostIFrameCheckout() {
      var _this = this;

      document.getElementsByClassName("sezzle-incontext-modal")[0].classList.add(this.IsVisibleClassName);

      if (this.checkoutURL) {
        document.getElementById("sezzle-incontext-modal-iframe").src = this.checkoutURL;
      } else {
        this.services.createCheckout(this.publicKey, this.checkoutObject).then(function (r) {
          try {
            var redirectURL = _this._getRedirectURL(r);

            if (!redirectURL) {
              throw new Error("Unable to fetch redirect URL");
            }

            document.getElementById("sezzle-incontext-modal-iframe").src = redirectURL;
          } catch (e) {
            alert(e);
    ...
    key: "_hostPopUpWindowCheckout",
    value: function _hostPopUpWindowCheckout() {
      var _this2 = this;

      if (!this.sezzleWindowElement || this.sezzleWindowElement && this.sezzleWindowElement.closed && this.sezzleWindowParams) {
        this.sezzleWindowElement = this.sezzleWindow.open("", "Sezzle", this.sezzleWindowParams.join());
        this.sezzleWindow.addEventListener("beforeunload", this.closeModal);

        if (this.sezzleLoaderElement) {
          if (this.checkoutURL) {
            this.sezzleWindowElement.location.href = this.checkoutURL;
          } else {
            this.services.createCheckout(this.publicKey, this.checkoutObject).then(function (r) {
              try {
                var redirectURL = _this2._getRedirectURL(r);

                if (!redirectURL) {
                  throw new Error("Unable to fetch redirect URL");
                }

                _this2.sezzleWindowElement.location.href = redirectURL;
              } catch (e) {
                alert(e);

                _this2.failureCallback();
          ...
          this.sezzleLoaderElement.style.display = 'flex';
        }
        ...
        this.interval = setInterval(function () {
          if (_this2.sezzleWindowElement && _this2.sezzleWindowElement.closed) {
        ...
        this.sezzleWindowElement.focus();
      }
    }
    /**
     * Get redirect URL
     *
     * @param {JSON} response Checkout POST response
    ...
    key: "_getRedirectURL",
    value: function _getRedirectURL(response) {
      if (response.code) {
        return "";
      }

      if (this.apiVersion === 'v1') {
        sessionStorage.setItem("order_identifier", this.checkoutObject.order_reference_id);
        return response.checkout_url;
      }

      if (this.isVirtualCard) {
        sessionStorage.setItem("virtual_card_checkout_session_id", response.uuid);
        return response.dashboard_url + this.queryString;
      }

      sessionStorage.setItem("order_identifier", response.order.uuid);
      return response.order.checkout_url;
    }
    /**
     * Add Sezzle Loader to DOM
     *
     * @param {boolean} activate Activate flag
     * @param {string} loaderText Loader Text
     */

  }, {
    key: "addSezzleLoader",
    value: function addSezzleLoader(activate, loaderText) {
      var _this3 = this;

      this.sezzleLoaderElement = document.createElement("div");
      this.sezzleLoaderElement.className = "page-loader";
      this.sezzleLoaderElement.style.display = activate ? "flex" : "none";
      this.sezzleLoaderElement.innerHTML = "<div class='loader-image'></div><div class='loader-text'>" + loaderText + "</div>";
      this.style.applyGoogleFont();
      this.style.applyLoaderCSS();
      document.body.appendChild(this.sezzleLoaderElement);
      this.sezzleLoaderElement.addEventListener('click', function () {
        if (_this3.sezzleWindowElement) {
          _this3.sezzleWindowElement.focus();
        }
      });
    }
  }]);
...
var button_Button = /*#__PURE__*/function () {
   ...
   * Constructor
   *
   * @param {JSON} options Config options for creating Sezzle button
   * @constructor
   */
  function Button(options) {
    button_classCallCheck(this, Button);

    this.sezzleButtonContainerElement = options.button_container;
    ...
    this.style = new style();
    this.sezzleButtonBackgroundColor = {
      light_purple: '#8333D4',
      dark_purple: '#382757',
      white: '#fff'
    };
  ...
  button_createClass(Button, [{
    ...
    value: function createButton() {
      this.style.applyButtonCSS();
      var sezzleSmartButton = document.createElement("button");
      sezzleSmartButton.id = this.sezzleButtonElementID;
      sezzleSmartButton.classList.add(this.sezzleButtonElementID);
      this.sezzleButtonContainerElement.append(sezzleSmartButton);
      this.sezzleButtonElement = document.getElementById(this.sezzleButtonElementID);

      this._designButton();
    }
    /**
     * Design the Sezzle Button
     *
     * @private
     */
    ...
    value: function _designButton() {
      ...
      this._addLetterSpacing();

      this._addImagePosition();
    }
    /**
     * Add Sezzle logo
     *
    ...
    value: function _addLogo() {
      if (this.sezzleButtonContainerElement.getAttribute('theme') === "dark") {
        this.sezzleLogo = 'https://media.sezzle.com/branding/2.0/Sezzle_Logo_FullColor.svg';
        this.sezzleButtonElement.classList.add('sezzle-smart-button-dark');
        this.sezzleButtonElement.style.background = this.sezzleButtonBackgroundColor.white;
      } else {
        this.sezzleLogo = 'https://media.sezzle.com/branding/2.0/Sezzle_Logo_FullColor_WhiteWM.svg';
        this.sezzleButtonElement.classList.add('sezzle-smart-button-light');
        this.sezzleButtonElement.style.background = this.sezzleButtonBackgroundColor.light_purple;
      }
    }
    /**
     * Add template
    ...
    value: function _addTemplate() {
      ...
      var sezzleButtonTemplate = this.sezzleButtonContainerElement.getAttribute('templateText') || "checkout with %%logo%%",
          templateArray = sezzleButtonTemplate.split(' '),
          templateString = '',
          sezzleImage = '';
      templateArray.forEach(function (subtemplate) {
        switch (subtemplate) {
          case '%%logo%%':
            sezzleImage = "<img class=".concat(_this.sezzleImageElementID, " src=").concat(_this.sezzleLogo, " />");
            break;

          default:
            templateString += "".concat(subtemplate, " ");
            break;
        }
      });
      templateString = "<span style=\"font-size: 1.3em; margin-right: 1px\">".concat(templateString, "</span>");
      this.sezzleButtonElement.innerHTML = "".concat(templateString).concat(sezzleImage);
    }
    /**
     * Set Sezzle Image Width
     *
     * @private
     */
    ...
    key: "_addImageWidth",
    value: function _addImageWidth() {
      document.getElementsByClassName("".concat(this.sezzleImageElementID))[0].style.width = this.sezzleButtonContainerElement.getAttribute('sezzleImageWidth') || '84px';
    }
    /**
     * Add height
     *
    ...
    key: "_addHeight",
    value: function _addHeight() {
      this.sezzleButtonElement.style.height = this.sezzleButtonContainerElement.getAttribute('height') || '4.2em';
    }
    /**
     * Add width
     *
    ...
    key: "_addWidth",
    value: function _addWidth() {
      this.sezzleButtonElement.style.width = this.sezzleButtonContainerElement.getAttribute('width') || '';
    }
    /**
    ...
    key: "_addCustomClass",
    value: function _addCustomClass() {
      var _this2 = this;

      var sezzleButtonClass = this.sezzleButtonContainerElement.getAttribute('customClass');

      if (sezzleButtonClass) {
        var customClassArray = sezzleButtonClass.split(',');
        customClassArray.forEach(function (className) {
          _this2.sezzleButtonElement.classList.add(className);
        });
      }
    }
    /**
    ...
    key: "_addBorderType",
    value: function _addBorderType() {
      switch (this.sezzleButtonContainerElement.getAttribute('borderType')) {
        case 'square':
          this.sezzleButtonElement.style.borderRadius = '0px';
          break;

        case 'semi-rounded':
          this.sezzleButtonElement.style.borderRadius = '10px';
          break;

        default:
          this.sezzleButtonElement.style.borderRadius = '300px';
          break;
      }

      this.sezzleButtonElement.style.border = 'solid';
    }
    /**
     * Add Padding
     *
    ...
    value: function _addPadding() {
      var paddingTop = this.sezzleButtonContainerElement.getAttribute('paddingTop'),
          paddingBottom = this.sezzleButtonContainerElement.getAttribute('paddingBottom'),
          paddingLeft = this.sezzleButtonContainerElement.getAttribute('paddingLeft'),
          paddingRight = this.sezzleButtonContainerElement.getAttribute('paddingRight');
      this.sezzleButtonElement.style.paddingTop = paddingTop || '1px';
      this.sezzleButtonElement.style.paddingBottom = paddingBottom || '7px';
      this.sezzleButtonElement.style.paddingLeft = paddingLeft || '30px';
      this.sezzleButtonElement.style.paddingRight = paddingRight || '30px';
    }
    /**
     * Add Letter Spacing
     *
    ...
    key: "_addLetterSpacing",
    value: function _addLetterSpacing() {
      var letterSpacing = this.sezzleButtonContainerElement.getAttribute('letterSpacing');
      this.sezzleButtonElement.style.letterSpacing = letterSpacing || '';
    }
    /**
     * Add Image Position
     *
    ...
    key: "_addImagePosition",
    value: function _addImagePosition() {
      var positionTop = this.sezzleButtonContainerElement.getAttribute('sezzleImagePositionTop'),
          positionBottom = this.sezzleButtonContainerElement.getAttribute('sezzleImagePositionBottom'),
          positionLeft = this.sezzleButtonContainerElement.getAttribute('sezzleImagePositionLeft'),
          positionRight = this.sezzleButtonContainerElement.getAttribute('sezzleImagePositionRight');
      document.getElementsByClassName("".concat(this.sezzleImageElementID))[0].style.top = positionTop || '';
      document.getElementsByClassName("".concat(this.sezzleImageElementID))[0].style.bottom = positionBottom || '';
      document.getElementsByClassName("".concat(this.sezzleImageElementID))[0].style.left = positionLeft || '';
      document.getElementsByClassName("".concat(this.sezzleImageElementID))[0].style.right = positionRight || '';
    }
  }]);
...
// CONCATENATED MODULE: ./src/checkout.js
...
var checkout_Checkout = /*#__PURE__*/function () {
  /**
   * Constructor
   *
   * @param {JSON} options Options passed from Client
   * @constructor
   */
  function Checkout(options) {
    ...
    this.apiMode = options.apiMode || null;
    this.isVirtualCard = options.isVirtualCard || false;
    this.postMessageOrigin = this._getPostMessageOrigin();
    this.sezzleButtonElement = options.button_id ? document.getElementById(options.button_id) : null;
    this.mode = new helper().isMobileTablet() && !this.isVirtualCard ? 'redirect' : options.mode || 'iframe';
    this.sezzleButtonElementID = "sezzle-smart-button";
    this.apiVersion = this.isVirtualCard ? 'v2' : options.apiVersion || null;
    ...
    this.modal = new modal({
      mode: this.mode,
      publicKey: this.publicKey,
      checkoutObject: this.checkoutObject,
      apiMode: this.apiMode,
      apiVersion: this.apiVersion,
   ...
   * Init SDK
   *
   * @param {JSON} arg Arguments passed for initialization
   */
  ...
  checkout_createClass(Checkout, [{
    ...
    value: function init(arg) {
      try {
        if (!arg.hasOwnProperty('onClick')) {
          throw new Error("onClick not defined");
        }

        if (this.mode === "iframe" || this.mode === "popup") {
          this.modal.makeModal();
        }

        var sezzleButtonElement = this.sezzleButtonElement || document.getElementById(this.sezzleButtonElementID);
        sezzleButtonElement.addEventListener("click", arg.onClick);
        this.checkoutObject = arg.checkoutObject || null;
        this.modal.checkoutObject = this.checkoutObject;
        this.OnCompleteCallback = arg.onComplete || null;
        this.OnCancelCallback = arg.onCancel || null;
        this.OnFailureCallback = arg.onFailure || null;
        this.modal.cancelCallback = this.OnCancelCallback;
        this.modal.failureCallback = this.OnFailureCallback;
      } catch (e) {
        alert(e);
      }
    }
     ...
     * Start Checkout
     *
     * @param {JSON} options Input Params
     */

  }, {
    key: "startCheckout",
    value: function startCheckout(options) {
      try {
        if (options.checkout_payload && !this.publicKey) {
          throw new Error("Public Key is missing.");
        } else if (!options.checkout_url && !options.checkout_payload) {
          throw "Checkout URL/Checkout Payload is missing";
        }

        if (options.checkout_url) {
          this.checkoutURL = options.checkout_url;
          this.modal.checkoutURL = options.checkout_url;
        } else if (options.checkout_payload) {
          this.checkoutObject = options.checkout_payload;
          this.modal.checkoutObject = this.checkoutObject;
        }
    ...
    /**
     * Render Sezzle Checkout Button
     *
     * @param {string} buttonContainer Sezzle button container element id
     */

  }, {
    key: "renderSezzleButton",
    value: function renderSezzleButton(buttonContainer) {
      try {
        if (!buttonContainer) {
          throw new Error("Sezzle Button container not there.");
        } else if (this.sezzleButtonElement) {
          throw new Error("Sezzle Button is already present. Please remove RenderSezzleButton.");
        }

        new src_button({
          button_container: buttonContainer ? document.getElementById(buttonContainer) : null
        }).createButton();
      } catch (e) {
        alert(e);
      }
     ...
     * Capture payment
     *
     * @param {JSON} options Capture config
     * @return {Promise}
     */

  }, {
    key: "capturePayment",
    value: function capturePayment(options) {
      try {
        if (!sessionStorage.getItem("order_identifier")) {
          throw new Error("Order Reference ID/Order UUID missing");
        } else if (!this.publicKey) {
          throw new Error("Public Key is missing");
        }

        return this.services.capturePayment(sessionStorage.getItem("order_identifier"), options.payload);
      } catch (e) {
        alert(e);
      }
    }
     ...
     *
     * @param {JSON} options Update Request Config
     * @return {Promise}
     *
     */

  }, {
    key: "setOrderReferenceID",
    value: function setOrderReferenceID(options) {
      try {
        if (!options.session_id || !options.order_id) {
          throw new Error("session_id/order_id missing");
        } else if (!this.publicKey) {
          throw new Error("Public Key is missing");
        }

        return this.services.updateVirtualCardCheckoutOrderID(options.session_id, {
     ...
     * @return {Array} installmentPlan Installment Plans
     */

  }, {
    key: "getInstallmentPlan",
    value: function getInstallmentPlan(amountInCents) {
      try {
        if (typeof amountInCents !== "number") {
          throw new Error("Amount type is not valid. Please pass number.");
        } else if (amountInCents <= 0) {
          throw new Error("Amount is not valid");
        }

        var paymentAmountInCents = Math.floor(amountInCents / this.noOfPayments),
            extraAmountLastPaymentInCents = Math.floor(amountInCents % this.noOfPayments),
            installmentPlan = {
          'schedule': 'bi-weekly',
        ...
        for (var i = 0; i < this.noOfPayments; i++) {
          var currentDate = new Date(),
              dueDate = new Date(currentDate.setDate(currentDate.getDate() + this.daysBetweenPayments * i)),
              installment = {
            'installment': i + 1,
            'amountInCents': paymentAmountInCents,
            'dueDate': "".concat(dueDate.getFullYear(), "-").concat(dueDate.getMonth() + 1, "-").concat(dueDate.getDate())
          };

          if (i === this.noOfPayments - 1) {
            installment.amountInCents += extraAmountLastPaymentInCents;
          }
    ...
    value: function closeModal() {
      if (this.modal.sezzleWindowElement && this.mode === "popup") {
        this.modal.closeModal();
      } else if (this.mode === "iframe") {
        document.querySelector(".sezzle-incontext-modal.is-visible").classList.remove(this.modal.IsVisibleClassName);
      }
    }
    /**
    ...
    value: function _addListeners() {
      ...
      window.addEventListener('message', function () {
        _this._postMessageListener();
      });

      if (this.mode === 'iframe') {
        document.addEventListener("click", function (e) {
          return _this.modal.closeModal(e);
        });
    ...
    key: "_getPostMessageOrigin",
    value: function _getPostMessageOrigin() {
      var sezzleBaseURL = "sezzle.com";
      var sezzleTargetURL = this.isVirtualCard ? "dashboard.".concat(sezzleBaseURL) : "checkout.".concat(sezzleBaseURL);

      if (this.apiMode === 'sandbox') {
        return "https://sandbox.".concat(sezzleTargetURL);
      }

      return "https://".concat(sezzleTargetURL);
    }
    /**
    ...
    key: "_postMessageListener",
    value: function _postMessageListener() {
      try {
        if (event.origin === this.postMessageOrigin) {
          if (this.isVirtualCard) {
            ...
            event.data.session_id = sessionStorage.getItem('virtual_card_checkout_session_id');

            this._onComplete();

            sessionStorage.removeItem("virtual_card_checkout_session_id");
            return;
          }
    ...
    value: function _redirect() {
      try {
        ...
        this.modal.addSezzleLoader(true, "Redirecting you to Sezzle Checkout....");
        ...
        if (this.checkoutURL) {
          ...
          this.services.createCheckout(this.publicKey, this.checkoutObject).then(function (r) {
            ...
            window.location.replace(r.checkout_url);
          });
        }
      } catch (e) {
        alert(e);
